"""phase7b_admin — outbound_request_log, data_source_status, dependency_audit_log, data_source_attribution
...
def upgrade() -> None:
    ...
    op.execute(
        ...
        "data_source_status, outbound_request_log, dependency_audit_log, data_source_attribution "
        "TO seam_app"
    )
    op.execute(
        "GRANT SELECT ON "
        "data_source_status, data_source_attribution "
        "TO seam_readonly"
    )
