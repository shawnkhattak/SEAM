  ...
  return (
    <div className="menu-popover glass-panel absolute right-28 top-14 z-[1000] w-56 text-xs text-[var(--text-secondary)]">
      <div className="flex items-center justify-between border-b border-[var(--border)] px-3 py-2">
        <span className="mono text-[10px] font-semibold uppercase tracking-[0.08em] text-[var(--text-muted)]">Geo Layers</span>
        <button onClick={onClose} className="leading-none text-[var(--text-muted)] hover:text-[var(--text-primary)]">✕</button>
      </div>
