...
function ArticleCard({
  ...
  item: ReturnType<typeof fetchNews> extends Promise<Array<infer T>> ? T : never;
  ...
  return (
    <li className="px-4 py-3 transition-colors hover:bg-white/60">
      ...
      >
        ...
        <ExternalLink size={12} className="mt-0.5 shrink-0 text-[var(--text-muted)] group-hover:text-[var(--accent-deep)]" />
      </a>
...
export function NewsDrawer({
  ...
  function handleEntityClick(entity: NewsEntity) {
    console.debug("entity clicked", entity);
  }
