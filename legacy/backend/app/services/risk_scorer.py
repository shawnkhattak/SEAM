"""Deterministic composite risk scoring (Phase 5a).

Formula (Decision 47, ADR-0026):
...
# Hardcoded per architecture — do NOT make these parameters
...
async def _flag_mou_score(
    ...
    if flag_code:
        # Use latest available year for this flag+mou combination
    ...
    # Detention override: any detention in last 24 months → 100
